...
public class PlayerCar extends Actor {
    ...
    public PlayerCar(TrafficGame trafficGame) {
        ...
        switch (Settings.skinSeleccionada) {
            case PersonajesSubMenu.SKIN_COCHE_DIABLO:
                keyframe = Assets.cocheDiablo;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_BANSHEE:
                keyframe = Assets.cocheBanshee;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_TORNADO:
                keyframe = Assets.cocheTornado;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_TURISMO:
                keyframe = Assets.cocheTurismo;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_AUDI_S5:
                keyframe = Assets.audiS5;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_BMW_X6:
                keyframe = Assets.bmwX6;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_BULLET:
                keyframe = Assets.cocheBullet;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_CHEVRLOTE_CROSSFIRE:
                keyframe = Assets.chevroletCrossfire;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_CITROEN_C4:
                keyframe = Assets.citroenC4;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_DODGE_CHARGER:
                keyframe = Assets.dodgeCharger;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_FIAT_500_LOUNGE:
                keyframe = Assets.fiat500Lounge;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_HONDA_CRV:
                keyframe = Assets.hondaCRV;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_MAZDA_6:
                keyframe = Assets.mazda6;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_MAZDA_RX8:
                keyframe = Assets.mazdaRX8;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_SEAT_IBIZA:
                keyframe = Assets.seatIbiza;
                width = keyframe.getRegionWidth();
                height = keyframe.getRegionHeight();
                break;
            case PersonajesSubMenu.SKIN_COCHE_VOLKSWAGEN_SCIROCCO:
            default:
