...
public class ShopScreen extends Screens {
	...
	public ShopScreen(final MainStreet game) {
		...
		Label lbShop = new Label("Tienda", Assets.labelStyleGrande);
	...
	private void initButtons() {
		btPersonajes = new Button(
				new TextureRegionDrawable(Assets.cocheTornado));
		...
		btPowerUps = new Button(new TextureRegionDrawable(Assets.cocheTornado));
